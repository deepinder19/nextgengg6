...
import org.opendaylight.yang.gen.v1.urn.opendaylight.groupbasedpolicy.apic.rev140528.APicConfig;
 ...
 * @author readams
 */
public class APicRenderer implements AutoCloseable, DataChangeListener {
    private static final Logger LOG =
            LoggerFactory.getLogger(APicRenderer.class);
    ...
    private static final InstanceIdentifier<APicConfig> configIid =
            InstanceIdentifier.builder(APicConfig.class).build();

    private APicConfig config;
    ListenerRegistration<DataChangeListener> configReg;

    public APicRenderer(DataBroker dataProvider,
                             RpcProviderRegistry rpcRegistry) {
        super();
        this.dataBroker = dataProvider;

        System.out.println("APIC Rendererrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr");
        writeLogs("APIC Rendererrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr");
        ...
        readConfig();
        LOG.info("Initialized APic renderer");
    ...
    private void readConfig() {
        ListenableFuture<Optional<APicConfig>> dao =
